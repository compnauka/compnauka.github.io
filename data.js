        ...
        const CATEGORIES = [
          ...
          },
          {
            ...
            color: "#8b5cf6", // Purple
            services: [
              { name: "Обчислювальне мислення", description: "Простими словами про обчислювальне мислення.", link: "services/compthinking.html", image: "images/1.jpg", tags: ["3-5 класи"] },
              ...
              { name: "Абстракція для дітей", description: "Інтерактивний урок про рівні абстракції.", link: "services/abstraction.html", image: "images/22.jpg", tags: ["3-4 класи"] },
              { name: "Виявлення шаблонів", description: "Інтерактивний урок про виявлення шаблонів.", link: "services/patterns.html", image: "images/23.jpg", tags: ["3-4 класи"] },
              { name: "Декомпозиція для дітей", description: "Інтерактивний урок про декомпозицію.", link: "services/decomposition.html", image: "images/24.jpg", tags: ["3-4 класи"] },
              { name: "Перевір себе", description: "Тест з обчислювального мислення.", link: "services/quiz.html", image: "images/55.jpg", tags: ["2-4 класи"] }
            ]
          },
          {
            id: "programming",
          ...
          },
          {
            ...
            color: "#6366f1", // Indigo
            services: [
              { name: "ЕЛІЗА. Перший чат-бот", description: "Дізнайтесь, якими були чат-боти на початку розвитку ШІ.", link: "games/eliza.html", image: "images/50.jpg", tags: ["4-6 класи"] },
          ...
          },
          {
            ...
            services: [
              ...
              { name: "Теніс", description: "Динамічний пінг-понг для двох гравців. Тренує швидкість реакції та координацію.", link: "games/tenis.html", image: "images/52.jpg", tags: [] },
              { name: "Морський бій", description: "Класична онлайн-гра для двох гравців. Розвиває стратегічне та критичне мислення.", link: "games/seabattle.html", image: "images/54.jpg", tags: [] },
