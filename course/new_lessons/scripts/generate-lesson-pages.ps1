...
$lessons = @(
  ...
  @{
    ...
    File = "simple-info-product-1-2.html"
  ...
  @{
    ...
    File = "work-alone-together-1-2.html"
  ...
  @{
    ...
    File = "internet-what-for-1-2.html"
  ...
  @{
    ...
    File = "check-before-share-1-2.html"
