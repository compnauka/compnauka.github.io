  ...
  function handleMenuAction(action) {
    switch (action) {
      ...
      case 'show-shortcuts':
        ...
        break;
      case 'show-about':
        ui.showAlert('Про АРТ Малюнки', 'АРТ Малюнки — графічний редактор у стилі вашого офісного набору. Основна палітра завжди видима, пензлик має кілька режимів, а фігури й штампи можна пересувати та змінювати за розміром.', '🎨');
        break;
      default:
        break;
    }
