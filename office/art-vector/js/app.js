...
• Експорт SVG підходить для подальшого редагування, PNG — для вставки в презентації та документи`, '💡');
      ...
      case 'show-shortcuts':
        ...
        break;
      case 'show-about':
        ui.showAlert('Про АРТ Вектор', 'АРТ Вектор — браузерний векторний редактор для шкільного офісного набору. Інтерфейс узгоджений з іншими програмами АРТ: кольоровий хедер, верхнє меню, компактна панель інструментів і чисте робоче поле без зайвих бокових підказок. Редактор працює без реєстрації, зберігає проєкти локально та дозволяє експортувати роботи у SVG і PNG.', '🧩');
        break;
      default:
        break;
    }
