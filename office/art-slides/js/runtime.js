...
async function onProjectFileSelected() {
  ...
  } catch { showAlert('Не вдалося відкрити файл', 'Перевірте, чи це файл АРТ Слайди (JSON).'); }
}
...
function showAbout() {
  showAlert('Про АРТ Слайди', 'АРТ Слайди — редактор презентацій для шкільного офісного пакета. Текст, зображення, фігури (прямокутник, коло, трикутник), PDF та режим показу.');
}
