...
### 3.3. Google Analytics — прибрано

Трекерів більше немає: GA4 і Plausible видалені з усього сайту. Лишився
Cloudflare Web Analytics, який платформа вставляє в HTML сама — без cookies і
фінгерпринтингу, з відправкою на власний домен сайту.
