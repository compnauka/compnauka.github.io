  ...
  return {
    ...
    targets: {
      keys: {
        ...
        hard: Array.from("абвгдеєжзиіїйклмнопрстуфхцчшщьюя1234567890")
      },
      combos: {
        easy: ["ва", "ла", "на", "ти", "то", "ра", "ст", "ко", "по", "ми", "но", "ро"],
        medium: ["про", "при", "ний", "ого", "ати", "ення", "ість", "ува", "ере", "ово", "вся", "ться"],
        hard: ["під", "над", "роз", "без", "ств", "ння", "зап", "ком", "швид", "клав", "трен", "друк"]
      },
      words: {
        ...
        hard: ["клавіатура", "комп'ютер", "підготовка", "результати", "знайомство", "організація", "суспільство", "продовжувати"]
      }
    }
  };
});
