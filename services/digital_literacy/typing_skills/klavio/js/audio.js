...
// ================================================================
// KLAVIО — audio.js
// Procedural audio engine using Web Audio API (no dependencies)
// ================================================================
...
const Audio = (() => {
  ...
  function tone(freq, type, duration, gainVal, startFreq) {
    try {
      ...
      if (startFreq) {
        osc.frequency.exponentialRampToValueAtTime(freq, c.currentTime + duration * 0.4);
      }
  ...
  return {
    ...
    error() {
      tone(180, 'sawtooth', 0.18, 0.18, 280);
    },

    levelUp() {
      [523, 659, 784, 1046].forEach((f, i) => {
        setTimeout(() => tone(f, 'sine', 0.3, 0.2), i * 80);
      });
    },

    streak(n) {
      const f = 600 + n * 30;
      tone(f, 'sine', 0.15, 0.2, f * 0.8);
    },
