  ...
  const EXAMPLE_PROJECTS = [
    ...
    },
    {
      ...
      project: {
        ...
        baseColors: { ...BASE_COLORS },
        shapes: [
          shape('shape-1', 'start-end', 'Початок', 498, 60),
          shape('shape-2', 'process', 'Глянути на термометр', 498, 154),
          shape('shape-3', 'decision', 'Нижче 0°?', 518, 290),
          shape('shape-4', 'process', 'Вдягнути шапку', 288, 470),
          shape('shape-5', 'process', 'Вийти на вулицю', 488, 624),
          shape('shape-6', 'start-end', 'Кінець', 488, 724),
        ],
        connections: [
          conn('conn-shape-1-shape-2', 'shape-1', 'shape-2'),
          conn('conn-shape-2-shape-3', 'shape-2', 'shape-3'),
          conn('conn-shape-3-shape-4-yes', 'shape-3', 'shape-4', 'yes'),
          conn('conn-shape-3-shape-5-no', 'shape-3', 'shape-5', 'no'),
          conn('conn-shape-4-shape-5', 'shape-4', 'shape-5', null, 'bypass-right'),
          conn('conn-shape-5-shape-6', 'shape-5', 'shape-6'),
        ],
      },
    },
    ...
    },
    {
      ...
      project: {
        ...
        shapes: [
          shape('shape-1', 'start-end', 'Початок', 498, 60),
          shape('shape-2', 'input-output', 'Ввести пароль', 500, 154),
          shape('shape-3', 'decision', 'Пароль правильний?', 518, 276),
          shape('shape-4', 'input-output', 'Ласкаво просимо!', 290, 460),
          shape('shape-5', 'input-output', 'Помилка! Спробуй ще раз', 720, 440),
          shape('shape-6', 'start-end', 'Кінець', 288, 562),
        ],
        connections: [
          conn('conn-shape-1-shape-2', 'shape-1', 'shape-2'),
          conn('conn-shape-2-shape-3', 'shape-2', 'shape-3'),
    ...
    },
    {
      ...
      project: {
        ...
        shapes: [
          shape('shape-1', 'start-end', 'Початок', 498, 60),
          shape('shape-2', 'decision', 'Каша є в тарілці?', 518, 190),
          shape('shape-3', 'process', 'З\'їсти ложку', 288, 400),
          shape('shape-4', 'start-end', 'Кінець', 708, 300),
        ],
        connections: [
          conn('conn-shape-1-shape-2', 'shape-1', 'shape-2'),
          conn('conn-shape-2-shape-3-yes', 'shape-2', 'shape-3', 'yes'),
          conn('conn-shape-2-shape-4-no', 'shape-2', 'shape-4', 'no'),
          conn('conn-shape-3-shape-2', 'shape-3', 'shape-2', null, 'bypass-left'),
        ],
      },
    },
  ];
