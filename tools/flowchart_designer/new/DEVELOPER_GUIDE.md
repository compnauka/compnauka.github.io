...
- [index.html](/d:/GIT/itnauka.org/tools/flowchart_designer/new/index.html) — основна сторінка редактора
- [style.css](/d:/GIT/itnauka.org/tools/flowchart_designer/new/style.css) — стилі редактора і локальна дизайн-система
- [script.js](/d:/GIT/itnauka.org/tools/flowchart_designer/new/script.js) — увесь UI-рантайм редактора
- [flowchart-core.js](/d:/GIT/itnauka.org/tools/flowchart_designer/new/flowchart-core.js) — ядро: маршрутизація, серіалізація, нормалізація
- [manual.html](/d:/GIT/itnauka.org/tools/flowchart_designer/new/manual.html) — довідник для учнів

Тести:

- [tests/flowchart-core.test.js](/d:/GIT/itnauka.org/tools/flowchart_designer/new/tests/flowchart-core.test.js) — логіка ядра
- [tests/encoding.test.js](/d:/GIT/itnauka.org/tools/flowchart_designer/new/tests/encoding.test.js) — перевірка на пошкодження кодування
...
Головний `state` у [script.js](/d:/GIT/itnauka.org/tools/flowchart_designer/new/script.js) містить:
...
2. Подивитися [index.html](/d:/GIT/itnauka.org/tools/flowchart_designer/new/index.html)
3. Знайти потрібну функцію в [script.js](/d:/GIT/itnauka.org/tools/flowchart_designer/new/script.js) через `rg`
4. Якщо зміна стосується маршрутизації або JSON, перейти в [flowchart-core.js](/d:/GIT/itnauka.org/tools/flowchart_designer/new/flowchart-core.js)
